...
function get_upcoming(region, mainWindow) {
  console.log(region);
  ...
  request.get(url, (err, res, body) => {
    ...
    var pairs = JSON.parse(body).objects
    var pairs_info = []
    for (var i in pairs) {
      pair = pairs[i]
      pair_info = {}
      ...
      pairs_info.push(pair_info)


    }
    mainWindow.send("upcoming", pairs_info)
...
module.exports.get_upcoming = get_upcoming
